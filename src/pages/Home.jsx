...
import { Search, MapPin, Star, TrendingUp, ArrowRight, Sparkles, Settings, HeartPulse, Briefcase, Scale, Palette, Monitor, BookOpen, Landmark, Calendar, Bell, ChevronRight } from 'lucide-react';
import './Home.css';
...
const Home = () => {
    ...
    const handleStreamClick = (streamId) => {
        navigate('/colleges', { state: { activeStream: streamId } });
    };
                    ...
                    <div className="container hero-container">
                        <div className="hero-content">
                            ...
                            <div className="hero-quick-actions">
                                <Link to="/colleges" className="btn-elegant-link">
                ...
                <section className="browse-streams">
                    <div className="container">
                        <div className="section-header">
                            ...
                            <Link to="/colleges" className="btn-link">View All Streams <ArrowRight size={16} /></Link>
                        </div>
